...
function renderQuestion() {
  ...
  answerOptions.innerHTML = `<p>
  <label>
    <input name="answers" type="radio" value="${questions[currentQuestion].choices[0]}" />
    <span id="option1">${questions[currentQuestion].choices[0]}</span>
  </label>
</p>
<p>
  <label>
    <input name="answers" type="radio" value="${questions[currentQuestion].choices[1]}" />
    <span id="option2">${questions[currentQuestion].choices[1]}</span>
  </label>
</p>
<p>
  <label>
    <input name="answers" type="radio" value="${questions[currentQuestion].choices[2]}" />
    <span id="option3">${questions[currentQuestion].choices[2]}</span>
  </label>
</p>
<p>
  <label>
    <input name="answers" type="radio" value="${questions[currentQuestion].choices[3]}"/>
    <span id="option4">${questions[currentQuestion].choices[3]}</span>
  </label>
</p>`;
}
